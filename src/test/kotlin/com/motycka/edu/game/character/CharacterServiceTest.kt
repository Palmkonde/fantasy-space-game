...
class CharacterServiceTest {
    ...
    fun `getCharacters should return filtered characters`() {
        ...
        `when`(characterRepository.selectByFilters(className, name))
            .thenReturn(listOf(warriorCharacter))
    ...
    fun `getCharacterById should return character when found`() {
        ...
        `when`(characterRepository.selectById(id)).thenReturn(warriorCharacter)
    ...
    fun `createCharacter should create and return new character`() {
        ...
        `when`(characterRepository.insertCharacter(request, accountId))
            .thenReturn(warriorCharacter)
    ...
    fun `getChallengers should return characters owned by current account`() {
        ...
        `when`(characterRepository.getOwnedCharacters(accountId))
            .thenReturn(ownedCharacters)
    ...
    fun `getOpponents should return characters not owned by current account`() {
        ...
        `when`(characterRepository.getNotOwnedCharacters(accountId))
    ...
    fun `upLevelCharacterById should update and return character`() {
        ...
        `when`(characterRepository.upLevelCharacter(id, request))
            .thenReturn(updatedWarrior)
